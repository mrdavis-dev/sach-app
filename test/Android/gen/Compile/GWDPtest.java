...
return mWD_WIN_paginarecibo;
 ...
 // WIN_transaccion
public GWDFWIN_transaccion mWD_WIN_transaccion = new GWDFWIN_transaccion();
 // accesseur de WIN_transaccion
public GWDFWIN_transaccion getWIN_transaccion()
{
mWD_WIN_transaccion.checkOuverture();
return mWD_WIN_transaccion;
}
...
ajouterFenetre("WIN_transaccion", mWD_WIN_transaccion);



}

// Code de déclaration de test
...
// gsVar1 is string
vWD_gsVar1 = new WDChaineU();

super.ajouterVariableGlobale("gsVar1",vWD_gsVar1);
...
////////////////////////////////////////////////////////////////////////////
static public WDObjet vWD_gsVar1 = WDVarNonAllouee.ref;
public String getVersionApplication(){ return "0.0.2.0";}
public String getNomSociete(){ return "";}
public String getNomAPK(){ return "ebsp cobradores";}
